...
def result_comp():
    return [{'compressorId':"364", 'time':1602130230000, 'anomaly_score':0.34, 'anomaly':0}, 
            {'compressorId':"364",  'time':1602130231000, 'anomaly_score':7.66, 'anomaly':1},
            {'compressorId':"364",  'time':1602130232000, 'anomaly_score':0.34, 'anomaly':0}, 
            {'compressorId':"364",  'time':1602130233000, 'anomaly_score':7.66, 'anomaly':1}]

def result_rect():
    return [{'rectifierId':'365','time':1602130230000, 'anomaly_score':11.34, 'anomaly':0}, 
            {'rectifierId':'365','time':1602130231000, 'anomaly_score':111.66, 'anomaly':1},
            {'rectifierId':'365', 'time':1602130232000, 'anomaly_score':11.34, 'anomaly':0}, 
            {'rectifierId':'365','time':1602130233000, 'anomaly_score':111.66, 'anomaly':1}]
    
    
[{'rectifierId':"366", 'time':1602130230000, 'anomaly_score':11.77, 'anomaly':0}, 
